...
Screenshot: ![Copy Color Scheme](assets/WWP-tools-page-10.png)
...
Screenshot: ![Copy Parameter](assets/WWP-tools-page-14.png)
...
Screenshot: ![Parking Count in Room](assets/WWP-tools-page-19.png)
...
3. The tag `_WWP_A_RoomTag_ParkingOccupancy` is populated.

## Replace Type Name
Location: WWPTools > 3. Project Management > Replace Type Name
Screenshot: ![Replace Type Name](assets/WWP-tools-page-17.png)
...
Screenshot: ![Match Filled Region](assets/WWP-tools-page-19.png)
...
Screenshot: ![AutoFill WWP_Area](assets/WWP-tools-page-26.png)
...
Screenshot: ![Copy Filters](assets/WWP-tools-page-11.png)
...
Screenshot: ![Door Tool](assets/WWP-tools-page-16.png)
...
Screenshot: ![Fire Rating Tool](assets/WWP-tools-page-21.png)
...
How to use:
1. Load `N:\Library\Design Software\Autodesk\Revit\Families\Annotations\Families\WWP_FireRating_FRR Line Based.rfa`.
2. Run the tool and follow prompts.
...
Screenshot: ![Fire Rating Tool](assets/WWP-tools-page-18.png)
...
Screenshot: ![Fire Rating Tool](assets/WWP-tools-page-20.png)
...
Screenshot: ![Marketing View Maker](assets/WWP-tools-page-24.png)
...
Screenshot: ![Project Stat Manager](assets/WWP-tools-page-22.png)
Purpose: Export selected schedules (WWP_*) to CSV.
How to use:
...
Screenshot: ![Project Stat Manager](assets/WWP-tools-page-23.png)
Purpose: Update all CSV exports for the stats workbook.
How to use:
1. Run UpdateStats to refresh CSV outputs.
2. In Excel, load each CSV into the corresponding WWP sheet (Data > From Text/CSV).
